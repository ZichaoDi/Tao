%%%== Simulate X-ray fluorescence of a given object with predifined detector and beam
global plotSpecSingle BeforeEmit plotTravel
global fig2  fig5 finalfig slice
global onlyXRF whichElement

Tomo_startup; %% add necessary paths
load Phantom3_Young %% load sample
onlyXRF=1; %% 1: only simulated no reconstruction
PlotObject=0;
