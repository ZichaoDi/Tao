...
%
% function [t,Yt,LSiter,LS] = ArmijoBacktrackPIR(objFctn,Yc,dY,Jc,dJ,varargin)
%
...
for LSiter =1:LSMaxIter,
  ...
  Range = geometry(xc+feval(trafo,Yt,xc),m,'VRange'); % compute range of volumes on tetrahedral partition
