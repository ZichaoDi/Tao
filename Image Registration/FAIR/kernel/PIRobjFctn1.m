...
function [Jc,para,dJ,H] = PIRobjFctn1(T,Rc,omega,omegat,m,mt,beta,M,wRef,xc,xt,wc)
...
[Dc,rc,dD,dr,d2psi] = distance(Tc(overlap),Rc(indR),omegat,mt,'doDerivative',doDerivative);
...
para = struct('Tc',Tc(overlap),'Rc',Rc,'Rsub',Rc(indR),'omega',omega,'omegat',omegat,'m',m,'mt',mt,'yc',yc,'Jc',Jc);
