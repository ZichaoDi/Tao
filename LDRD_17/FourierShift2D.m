function y = FourierShift2D(x, delta_x,delta_y)
%
...
x_shift = exp(-i * 2 * pi .* delta_x .* [0:floor(N/2)-1 floor(-N/2):-1]' / N);
y_shift = exp(-i * 2 * pi .* delta_y .* [0:floor(M/2)-1 floor(-M/2):-1] / M);
