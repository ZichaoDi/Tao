...
for n=1:numThetan
    ...
    TransMatrix=[cos(theta) sin(theta) x0-cos(theta)*x0-sin(theta)*y0;-sin(theta) cos(theta) y0+sin(theta)*x0-cos(theta)*y0; 0 0 1];
    ...
    SSDknot=[SSDlet ones(size(DetKnot0,1),1)]*TransMatrix;
    SSDknot=SSDknot(:,1:2);
    %{ 
    % ============================================================
