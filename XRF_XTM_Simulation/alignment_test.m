...
shift_b=[0 1.06 0 0];
figure,
subplot('position',positionVector1+shift_l*widthF*(1-1)),imagesc(flipud(P'));set(gca,'XTick',[],'YTick',[]) ;
subplot('position',positionVector1+shift_l*widthF*(2-1)),imagesc(P_d);set(gca,'XTick',[],'YTick',[]) ;
subplot('position',positionVector1+shift_l*widthF*(3-1)),imagesc(P_s);set(gca,'XTick',[],'YTick',[]) ;
return;
colNum=3;
