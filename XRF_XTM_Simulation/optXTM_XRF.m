...
elseif(Joint==0)
    fctn=@(W)sfun_XRF_XTM1(W,XRF,DisR,MU_e,M,NumElement,numChannel,Ltol,GlobalInd,LocalInd,L_after,thetan,m,nTau,I0);
else
...
% % [xstar,fval] = fminunc(fctn,x0,options);
% errTol=norm(xstar-Wtest(:))/norm(xinitial-Wtest(:));
