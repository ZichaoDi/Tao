...
nTau=nTau;%ceil(Tau/dTau)+2; % number of discrete beam
tol=2; %%the threshod to gurantee the beam will cover the whole object
...
DetChannel=DetChannel;%linspace(0,DetScaleXRF,numChannel)';
NumSSDlet=10;
