...
%  - output-mode: plain
%  - output-file: outputs/a_func_Tensor.m
%  - output-file-prefix: 
%  - output-directory: outputs
%
% Functions in this file: a_func_Tensor, rec_func_Tensor,
%  ret_func_Tensor
%

function [a_W nr_f] = a_func_Tensor(W, xrfData, M, NumElement, L, GlobalInd, SelfInd, thetan, m, nTau, a_f)
...
function f = rec_func_Tensor(W, xrfData, M, NumElement, L, GlobalInd, SelfInd, thetan, m, nTau)
   global NumSSDlet numChannel NoSelfAbsorption;
   global mtol;
   tmpca3 = 0;
   tmpca2 = 0;
...
function a_W = ret_func_Tensor(a_f)
   global NumSSDlet numChannel NoSelfAbsorption;
   global mtol;
